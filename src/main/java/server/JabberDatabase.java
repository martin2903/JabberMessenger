...
public class JabberDatabase {
    ...
    /**
     * A convenience method to get the next userId whenever new db entries are made
     * @return the next available identity (usedId).
     */
    ...
    /**
     * A convenience method to remove duplicated lists.
     * @return a list containing unique lists.
     */
    private ArrayList<ArrayList<String>> removeDuplicates(List<ArrayList<String>> list) {
    ...
    /**
     * Connects to the database. Called by the default constructor
     */
     ...
     * (e.g. the root directory of the project).
     */
    ...
    /**
     * Executes multiple database updates
     */
